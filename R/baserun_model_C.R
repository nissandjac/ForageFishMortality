...
parameters = list(Rmaxlog = log(1000),
                  #SDlog = log(0.2),#,#,
                  SDlogsurv = log(0.2),
                  logSDR = log(0.6), # Recruitment error 
                  logSDF = log(1),
                  lognF = log(0.05),
                  lFstart = log(1),
                  logmuF = log(10),
...
compile("baserun_model_C.cpp")
dyn.load(dynlib("baserun_model_C"))

obj <-MakeADFun(data,parameters,DLL="baserun_model_C", random = 'U')
